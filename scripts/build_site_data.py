...
RESTAURANTS = [
    ...
    {'name': 'Jasper Pizza Place', 'night': 'Day 3 \u00b7 June 26', 'time': 'lunch',
     'address': '402 Connaught Dr, Jasper', 'phone': '(780) 852-3225',
     'blurb': 'Wood-fired pizza at the far end of the Icefields Parkway run \u2014 the halfway fuel-up before turning back south.',
     'mapsUrl': 'https://www.google.com/maps/search/?api=1&query=Jasper%20Pizza%20Place'},
    ...
    {'name': 'Truffle Pigs Bistro', 'night': 'Day 5 \u00b7 June 28', 'time': 'lunch',
     'address': '100 Centre St, Field, BC', 'phone': '(250) 343-6303',
     'blurb': 'The beloved little bistro in Field, tucked inside Yoho \u2014 lunch between waterfalls.',
     'mapsUrl': 'https://www.google.com/maps/search/?api=1&query=Truffle%20Pigs%20Bistro%20Field%20BC'},
